...
rbtdef.frictionmodel = {'Coulomb', 'offset', 'viscous'} # options are None or a combination of 'Coulomb', 'viscous' and 'offset'
...
with open(r"../results/dyn_franka_viscous\get_Regressorb.m", "w", encoding="utf-8") as f:
    f.write(Regressorb_func_str)

with open(r"../results/dyn_franka_viscous\get_Torque.m", "w", encoding="utf-8") as f:
